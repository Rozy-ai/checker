...
<div class='slider__view-2 [ SLIDER ] product-view__slider'  >
    <?php foreach ($items as $index => $item): ?>
        ...
        <div
            ...
            class="tbl d-block [ SLIDER-ITEM ] slider__slider-item -v-2 <?= $number_page_current === $index ? '-current' : '' ?> item<?= (int)$node === $index ? " slick-current" : '' ?>"
        >
            <div class="tr d-flex slider-item__border <?= $number_page_current === $index ? '-current' : '' ?> -v-2 h-100 pt-0 pb-0">
                    ...
                    <div class="d-flex justify-content-between h-100">
                        <div class="d-flex flex-column justify-content-between w-100 products-list__info">
                            ...
                            <?php if ((count($variables_right['images_right']) > 1)): ?>
                                <div class="slider__right-item-other-imgs d-flex overflow-auto">
                        ...
                        <div class="products-list__actions text-right">
                            <div
