...
lib.brief_on_hover1 = function(selector, prop, cb){
    ...
    if (typeof prop === 'object'){
        if (typeof prop.offset_left !== 'undefined') left = prop.offset_left;
        if (typeof prop.offset_top !== 'undefined') top = prop.offset_top;
        if (typeof prop.arrow_position !== 'undefined') arrow_position = prop.arrow_position; // left | right | top | top_center | bottom
    }
